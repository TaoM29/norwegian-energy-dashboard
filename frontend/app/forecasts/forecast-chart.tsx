...
const modelColours: Record<string, { line: string; token: string }> = {
  ...
  ridge_calendar: { line: "#3f7eaa", token: "var(--chart-series-2)" },
  ridge_calendar_demand: { line: "#d4774d", token: "#f0936e" },
  ridge_calendar_demand_weather: { line: "#176b59", token: "var(--chart-series-1)" },
